#ifndef __CHARSET_BRAZILIAN_S11_H__
#define __CHARSET_BRAZILIAN_S11_H__

/*-----------------------------------------------------------------------------
  MSX Brazilian Sharp HB-8000 v1.1 Charset.
  
  This charset was superseded by the brazilian BRASCII charset.
-----------------------------------------------------------------------------*/  
unsigned char const charset_brazilian_s11[2048] = {
