#ifndef __CHARSET_GERMAN_H__
#define __CHARSET_GERMAN_H__

/*-----------------------------------------------------------------------------
  MSX German Charset.
  
  Same characters as International charset, but with minor differences in the 
  number zero (ASCII code 0x30) graphics.
-----------------------------------------------------------------------------*/  
unsigned char const charset_german[2048] = {
